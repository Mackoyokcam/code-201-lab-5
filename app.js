...
function sumArray(testArray){ //eslint-disable-line
  ...
  var message = sum(sum(sum(sum(sum(sum(sum(testArray[0], ',')[0], testArray[1])[0], ',')[0], testArray[2])[0], ' was passed in as an array of numbers, and ')[0], theSum)[0], ' is their sum.')[0];
